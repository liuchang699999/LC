...
class Post:
    ...
    def showScalar(self,region,scalar,name = 'scalar'):
        # 显示标量
        ...
        pl = pv.Plotter()
        pl.add_mesh(mesh, scalars=scalar, **dargs,show_edges=True)
        pl.background_color = 'white'
        pl.add_camera_orientation_widget()
        pl.add_text("sumNode = "+str(region.mesh.sumNode)+"\n sumElem = "+str(region.mesh.sumElem), color='k')
        pl.show()

    def showDisplacement(self,region,displacement,direction = 'all',sym = 'none',
        ...
        if direction == 'all':
            ...
            if self.ndim == 2:
                ...
                pl.add_mesh(mesh.copy(),  **dargs,show_edges=True)
